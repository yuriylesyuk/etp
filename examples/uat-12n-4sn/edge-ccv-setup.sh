...
ansible n01,n07,n08,n09,n10,n11,n12,n05,n02,n03,n04,n06 -ba "iptables -t filter -A CONSUL_INPUT -m owner --uid-owner consul -j RETURN"
ansible n01,n07,n08,n09,n10,n11,n12,n05,n02,n03,n04,n06 -ba "iptables -t filter -A CONSUL_INPUT -m owner --gid-owner consul -j RETURN"

ansible n01,n07,n08,n09,n10,n11,n12,n05,n02,n03,n04,n06 -ba "iptables -t filter -F CONSUL_INPUT"
ansible n01,n07,n08,n09,n10,n11,n12,n05,n02,n03,n04,n06 -ba "iptables -t filter -X CONSUL_INPUT"
ansible n01,n07,n08,n09,n10,n11,n12,n05,n02,n03,n04,n06 -ba "iptables -t filter -N CONSUL_INPUT"
ansible n01,n07,n08,n09,n10,n11,n12,n05,n02,n03,n04,n06 -ba "iptables -t filter -A OUTPUT -p tcp -j CONSUL_INPUT"
ansible n01,n07,n08,n09,n10,n11,n12,n05,n02,n03,n04,n06 -ba "iptables -t filter -A CONSUL_INPUT -m owner --uid-owner consul -j RETURN"
ansible n01,n07,n08,n09,n10,n11,n12,n05,n02,n03,n04,n06 -ba "iptables -t filter -A CONSUL_INPUT -m owner --gid-owner consul -j RETURN"

ansible n01,n07,n08,n09,n10,n11,n12,n05,n02,n03,n04,n06 -ba "iptables -t nat -F CONSUL_INPUT"
ansible n01,n07,n08,n09,n10,n11,n12,n05,n02,n03,n04,n06 -ba "iptables -t nat -X CONSUL_INPUT"
ansible n01,n07,n08,n09,n10,n11,n12,n05,n02,n03,n04,n06 -ba "iptables -t nat -N CONSUL_INPUT"
ansible n01,n07,n08,n09,n10,n11,n12,n05,n02,n03,n04,n06 -ba "iptables -t nat -A INPUT -p tcp -j CONSUL_INPUT"
ansible n01,n07,n08,n09,n10,n11,n12,n05,n02,n03,n04,n06 -ba "iptables -t nat -A CONSUL_INPUT -m owner --uid-owner consul -j RETURN"
ansible n01,n07,n08,n09,n10,n11,n12,n05,n02,n03,n04,n06 -ba "iptables -t nat -A CONSUL_INPUT -m owner --gid-owner consul -j RETURN"

ansible n01,n07,n08,n09,n10,n11,n12,n05,n02,n03,n04,n06 -ba "iptables -t nat -F CONSUL_INPUT"
ansible n01,n07,n08,n09,n10,n11,n12,n05,n02,n03,n04,n06 -ba "iptables -t nat -X CONSUL_INPUT"
ansible n01,n07,n08,n09,n10,n11,n12,n05,n02,n03,n04,n06 -ba "iptables -t nat -N CONSUL_INPUT"
ansible n01,n07,n08,n09,n10,n11,n12,n05,n02,n03,n04,n06 -ba "iptables -t nat -A OUTPUT -p tcp -j CONSUL_INPUT"
ansible n01,n07,n08,n09,n10,n11,n12,n05,n02,n03,n04,n06 -ba "iptables -t nat -A CONSUL_INPUT -m owner --uid-owner consul -j RETURN"
ansible n01,n07,n08,n09,n10,n11,n12,n05,n02,n03,n04,n06 -ba "iptables -t nat -A CONSUL_INPUT -m owner --gid-owner consul -j RETURN"
...
ansible n07,n08,n09,n10,n11,n12,n05,n06 -m shell -a 'nohup consul connect proxy -service edge-zk-2181 $upstreams  &> /opt/hashicorp/consul/logs/edge-zk-2181.log & echo $! > /opt/hashicorp/consul/logs/edge-zk-2181.pid'
#
...
ansible n07,n08,n09,n10,n11,n12,n05,n06 -m shell -a 'nohup consul connect proxy -service edge-ms-8080 $upstreams  &> /opt/hashicorp/consul/logs/edge-ms-8080.log & echo $! > /opt/hashicorp/consul/logs/edge-ms-8080.pid'
#
