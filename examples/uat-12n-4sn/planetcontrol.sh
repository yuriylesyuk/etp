...
then
   $DRYRUN ansible n05 -a $DRYESC$DRYQUOTE"apigee-service apigee-influx $ACTION$DRYESC$DRYQUOTE"
...
if [[ ";dc-1;planet;" =~ ";$TARGET;" ]]
then
   $DRYRUN ansible n10 -a $DRYESC$DRYQUOTE"apigee-service apigee-telegraf $ACTION$DRYESC$DRYQUOTE"
   if [[ $? -ne 0 ]]; then exit 1; fi
fi
...
if [[ ";dc-1;planet;" =~ ";$TARGET;" ]]
then
   $DRYRUN ansible n05 -a $DRYESC$DRYQUOTE"apigee-service apigee-grafana $ACTION$DRYESC$DRYQUOTE"
   if [[ $? -ne 0 ]]; then exit 1; fi
fi
...
if [[ ";dc-1;planet;" =~ ";$TARGET;" ]]
then
   $DRYRUN ansible n06 -a $DRYESC$DRYQUOTE"apigee-service apigee-postgresql $ACTION$DRYESC$DRYQUOTE"
   if [[ $? -ne 0 ]]; then exit 1; fi
fi
...
if [[ ";dc-1;planet;" =~ ";$TARGET;" ]]
then
   $DRYRUN ansible n06 -a $DRYESC$DRYQUOTE"apigee-service edge-postgres-server $ACTION$DRYESC$DRYQUOTE"
   if [[ $? -ne 0 ]]; then exit 1; fi
fi
...
if [[ ";dc-1;planet;" =~ ";$TARGET;" ]]
then
   $DRYRUN ansible n06 -a $DRYESC$DRYQUOTE"apigee-service apigee-qpidd $ACTION$DRYESC$DRYQUOTE"
   if [[ $? -ne 0 ]]; then exit 1; fi
fi
...
if [[ ";dc-1;planet;" =~ ";$TARGET;" ]]
then
   $DRYRUN ansible n06 -a $DRYESC$DRYQUOTE"apigee-service edge-qpid-server $ACTION$DRYESC$DRYQUOTE"
   if [[ $? -ne 0 ]]; then exit 1; fi
fi
...
if [[ ";dc-1;planet;" =~ ";$TARGET;" ]]
then
   $DRYRUN ansible n09 -a $DRYESC$DRYQUOTE"apigee-service edge-message-processor $ACTION$DRYESC$DRYQUOTE"
   if [[ $? -ne 0 ]]; then exit 1; fi
fi
...
if [[ ";dc-1;planet;" =~ ";$TARGET;" ]]
then
   $DRYRUN ansible n10 -a $DRYESC$DRYQUOTE"apigee-service edge-message-processor $ACTION$DRYESC$DRYQUOTE"
   if [[ $? -ne 0 ]]; then exit 1; fi
fi
...
if [[ ";dc-1;planet;" =~ ";$TARGET;" ]]
then
   $DRYRUN ansible n11 -a $DRYESC$DRYQUOTE"apigee-service edge-message-processor $ACTION$DRYESC$DRYQUOTE"
   if [[ $? -ne 0 ]]; then exit 1; fi
fi
...
if [[ ";dc-1;planet;" =~ ";$TARGET;" ]]
then
   $DRYRUN ansible n12 -a $DRYESC$DRYQUOTE"apigee-service edge-message-processor $ACTION$DRYESC$DRYQUOTE"
   if [[ $? -ne 0 ]]; then exit 1; fi
fi
...
if [[ ";dc-1;planet;" =~ ";$TARGET;" ]]
then
   $DRYRUN ansible n05 -a $DRYESC$DRYQUOTE"apigee-service baas-sap-usergrid $ACTION$DRYESC$DRYQUOTE"
   if [[ $? -ne 0 ]]; then exit 1; fi
fi
...
if [[ ";dc-1;planet;" =~ ";$TARGET;" ]]
then
   $DRYRUN ansible n05 -a $DRYESC$DRYQUOTE"apigee-service baas-sap-portal $ACTION$DRYESC$DRYQUOTE"
   if [[ $? -ne 0 ]]; then exit 1; fi
fi
