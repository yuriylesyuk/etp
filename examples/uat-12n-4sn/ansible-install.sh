...
ansible-playbook -l n09 $OPS_HOME/edge-comp-setup.yml -e "COMP=ms CFG=uat-dc1-n09-ms.cfg"

ansible-playbook -l n09 $OPS_HOME/edge-comp-setup.yml -e "COMP=ui CFG=uat-dc1-all-ms.cfg"

ansible-playbook -l n05 $OPS_HOME/edge-comp-setup.yml -e "COMP=qs CFG=uat-dc1-all-ms.cfg"
ansible-playbook -l n06 $OPS_HOME/edge-comp-setup.yml -e "COMP=qs CFG=uat-dc1-all-ms.cfg"

ansible-playbook -l n06 $OPS_HOME/edge-comp-setup.yml -e "COMP=ps CFG=uat-dc1-all-ms.cfg"
...
ansible-playbook -l n09 $OPS_HOME/edge-comp-setup.yml -e "COMP=mp CFG=uat-dc1-all-ms.cfg"
ansible-playbook -l n10 $OPS_HOME/edge-comp-setup.yml -e "COMP=mp CFG=uat-dc1-all-ms.cfg"
ansible-playbook -l n11 $OPS_HOME/edge-comp-setup.yml -e "COMP=mp CFG=uat-dc1-all-ms.cfg"
ansible-playbook -l n12 $OPS_HOME/edge-comp-setup.yml -e "COMP=mp CFG=uat-dc1-all-ms.cfg"



ansible-playbook -l n05 $OPS_HOME/edge-comp-setup.yml -e "COMP=b CFG=uat-dc1-n05-bs.cfg"

ansible-playbook -l n05 $OPS_HOME/edge-comp-setup.yml -e "COMP=p CFG=uat-dc1-all-ms.cfg"

ansible-playbook -l n01 $OPS_HOME/edge-comp-setup.yml -e "COMP=dp CFG=uat-dc1-all-ms.cfg"

ansible-playbook -l n05 $OPS_HOME/edge-comp.yml -e "COMP=influxdb CFG=uat-dc1-all-ms.cfg"
...
ansible-playbook -l n10 $OPS_HOME/edge-comp.yml -e "COMP=telegraf CFG=uat-dc1-all-ms.cfg"
...
ansible-playbook -l n05 $OPS_HOME/edge-comp.yml -e "COMP=grafana CFG=uat-dc1-all-ms.cfg"
