...
#
set +e
ansible n01,n02,n03,n04,n05 -ba "iptables -t filter -F"
ansible n01,n02,n03,n04,n05 -ba "iptables -t filter -X"
set -e
...
### TODO: [ ] remove two sections for filter CONSUL_OUTPUT AND nat CONSUL_INPUT

set +e
ansible n01,n02,n03,n04,n05 -ba "iptables -t nat -F"
ansible n01,n02,n03,n04,n05 -ba "iptables -t nat -X"
set -e
...
#####
###### TODO [ ] if no ports, do not generate statement
