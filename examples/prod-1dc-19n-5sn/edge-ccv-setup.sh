...
ansible n01,n02,n08,n09,n03,n04,n05,n06,n07,n10,n11,n12,n13,n15,n16,n17,n18,n19,n29 -ba "iptables -t filter -A CONSUL_INPUT -m owner --uid-owner consul -j RETURN"
ansible n01,n02,n08,n09,n03,n04,n05,n06,n07,n10,n11,n12,n13,n15,n16,n17,n18,n19,n29 -ba "iptables -t filter -A CONSUL_INPUT -m owner --gid-owner consul -j RETURN"

ansible n01,n02,n08,n09,n03,n04,n05,n06,n07,n10,n11,n12,n13,n15,n16,n17,n18,n19,n29 -ba "iptables -t filter -F CONSUL_INPUT"
ansible n01,n02,n08,n09,n03,n04,n05,n06,n07,n10,n11,n12,n13,n15,n16,n17,n18,n19,n29 -ba "iptables -t filter -X CONSUL_INPUT"
ansible n01,n02,n08,n09,n03,n04,n05,n06,n07,n10,n11,n12,n13,n15,n16,n17,n18,n19,n29 -ba "iptables -t filter -N CONSUL_INPUT"
ansible n01,n02,n08,n09,n03,n04,n05,n06,n07,n10,n11,n12,n13,n15,n16,n17,n18,n19,n29 -ba "iptables -t filter -A OUTPUT -p tcp -j CONSUL_INPUT"
ansible n01,n02,n08,n09,n03,n04,n05,n06,n07,n10,n11,n12,n13,n15,n16,n17,n18,n19,n29 -ba "iptables -t filter -A CONSUL_INPUT -m owner --uid-owner consul -j RETURN"
ansible n01,n02,n08,n09,n03,n04,n05,n06,n07,n10,n11,n12,n13,n15,n16,n17,n18,n19,n29 -ba "iptables -t filter -A CONSUL_INPUT -m owner --gid-owner consul -j RETURN"

ansible n01,n02,n08,n09,n03,n04,n05,n06,n07,n10,n11,n12,n13,n15,n16,n17,n18,n19,n29 -ba "iptables -t nat -F CONSUL_INPUT"
ansible n01,n02,n08,n09,n03,n04,n05,n06,n07,n10,n11,n12,n13,n15,n16,n17,n18,n19,n29 -ba "iptables -t nat -X CONSUL_INPUT"
ansible n01,n02,n08,n09,n03,n04,n05,n06,n07,n10,n11,n12,n13,n15,n16,n17,n18,n19,n29 -ba "iptables -t nat -N CONSUL_INPUT"
ansible n01,n02,n08,n09,n03,n04,n05,n06,n07,n10,n11,n12,n13,n15,n16,n17,n18,n19,n29 -ba "iptables -t nat -A INPUT -p tcp -j CONSUL_INPUT"
ansible n01,n02,n08,n09,n03,n04,n05,n06,n07,n10,n11,n12,n13,n15,n16,n17,n18,n19,n29 -ba "iptables -t nat -A CONSUL_INPUT -m owner --uid-owner consul -j RETURN"
ansible n01,n02,n08,n09,n03,n04,n05,n06,n07,n10,n11,n12,n13,n15,n16,n17,n18,n19,n29 -ba "iptables -t nat -A CONSUL_INPUT -m owner --gid-owner consul -j RETURN"

ansible n01,n02,n08,n09,n03,n04,n05,n06,n07,n10,n11,n12,n13,n15,n16,n17,n18,n19,n29 -ba "iptables -t nat -F CONSUL_INPUT"
ansible n01,n02,n08,n09,n03,n04,n05,n06,n07,n10,n11,n12,n13,n15,n16,n17,n18,n19,n29 -ba "iptables -t nat -X CONSUL_INPUT"
ansible n01,n02,n08,n09,n03,n04,n05,n06,n07,n10,n11,n12,n13,n15,n16,n17,n18,n19,n29 -ba "iptables -t nat -N CONSUL_INPUT"
ansible n01,n02,n08,n09,n03,n04,n05,n06,n07,n10,n11,n12,n13,n15,n16,n17,n18,n19,n29 -ba "iptables -t nat -A OUTPUT -p tcp -j CONSUL_INPUT"
ansible n01,n02,n08,n09,n03,n04,n05,n06,n07,n10,n11,n12,n13,n15,n16,n17,n18,n19,n29 -ba "iptables -t nat -A CONSUL_INPUT -m owner --uid-owner consul -j RETURN"
ansible n01,n02,n08,n09,n03,n04,n05,n06,n07,n10,n11,n12,n13,n15,n16,n17,n18,n19,n29 -ba "iptables -t nat -A CONSUL_INPUT -m owner --gid-owner consul -j RETURN"
...
ansible n02 -ba "iptables -t filter -A CONSUL_INPUT -i eth0  -p tcp -m multiport --dports  -m state --state NEW,ESTABLISHED -j REJECT"
...
ansible n09 -ba "iptables -t filter -A CONSUL_INPUT -i eth0  -p tcp -m multiport --dports  -m state --state NEW,ESTABLISHED -j REJECT"
...
ansible n03 -ba "iptables -t filter -A CONSUL_INPUT -i eth0  -p tcp -m multiport --dports 8080 -m state --state NEW,ESTABLISHED -j REJECT"
...
ansible n19 -ba "iptables -t filter -A CONSUL_INPUT -i eth0  -p tcp -m multiport --dports  -m state --state NEW,ESTABLISHED -j REJECT"
...
ansible n29 -ba "iptables -t filter -A CONSUL_INPUT -i eth0  -p tcp -m multiport --dports  -m state --state NEW,ESTABLISHED -j REJECT"
...
ansible n13 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n13-zk-2181  &> /opt/hashicorp/consul/logs/edge-n13-zk-2181.log &  echo $! > /opt/hashicorp/consul/logs/edge-n13-zk-2181.pid'
...
ansible n15 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n15-zk-2181  &> /opt/hashicorp/consul/logs/edge-n15-zk-2181.log &  echo $! > /opt/hashicorp/consul/logs/edge-n15-zk-2181.pid'
...
ansible n16 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n16-zk-2181  &> /opt/hashicorp/consul/logs/edge-n16-zk-2181.log &  echo $! > /opt/hashicorp/consul/logs/edge-n16-zk-2181.pid'
...
ansible n17 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n17-zk-2181  &> /opt/hashicorp/consul/logs/edge-n17-zk-2181.log &  echo $! > /opt/hashicorp/consul/logs/edge-n17-zk-2181.pid'
...
ansible n18 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n18-zk-2181  &> /opt/hashicorp/consul/logs/edge-n18-zk-2181.log &  echo $! > /opt/hashicorp/consul/logs/edge-n18-zk-2181.pid'

ansible n01,n02,n03,n04,n05,n06,n07,n19 -m shell -a 'nohup consul connect proxy -service edge-zk-2181 $upstreams  &> /opt/hashicorp/consul/logs/edge-zk-2181.log & echo $! > /opt/hashicorp/consul/logs/edge-zk-2181.pid'
#
...
ansible n13 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n13-zk-2888  &> /opt/hashicorp/consul/logs/edge-n13-zk-2888.log &  echo $! > /opt/hashicorp/consul/logs/edge-n13-zk-2888.pid'
...
ansible n15 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n15-zk-2888  &> /opt/hashicorp/consul/logs/edge-n15-zk-2888.log &  echo $! > /opt/hashicorp/consul/logs/edge-n15-zk-2888.pid'
...
ansible n16 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n16-zk-2888  &> /opt/hashicorp/consul/logs/edge-n16-zk-2888.log &  echo $! > /opt/hashicorp/consul/logs/edge-n16-zk-2888.pid'
...
ansible n17 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n17-zk-2888  &> /opt/hashicorp/consul/logs/edge-n17-zk-2888.log &  echo $! > /opt/hashicorp/consul/logs/edge-n17-zk-2888.pid'
...
ansible n18 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n18-zk-2888  &> /opt/hashicorp/consul/logs/edge-n18-zk-2888.log &  echo $! > /opt/hashicorp/consul/logs/edge-n18-zk-2888.pid'

ansible n13,n15,n16,n17,n18 -m shell -a 'nohup consul connect proxy -service edge-zk-2888 $upstreams  &> /opt/hashicorp/consul/logs/edge-zk-2888.log & echo $! > /opt/hashicorp/consul/logs/edge-zk-2888.pid'
#
...
ansible n13 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n13-zk-3888  &> /opt/hashicorp/consul/logs/edge-n13-zk-3888.log &  echo $! > /opt/hashicorp/consul/logs/edge-n13-zk-3888.pid'
...
ansible n15 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n15-zk-3888  &> /opt/hashicorp/consul/logs/edge-n15-zk-3888.log &  echo $! > /opt/hashicorp/consul/logs/edge-n15-zk-3888.pid'
...
ansible n16 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n16-zk-3888  &> /opt/hashicorp/consul/logs/edge-n16-zk-3888.log &  echo $! > /opt/hashicorp/consul/logs/edge-n16-zk-3888.pid'
...
ansible n17 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n17-zk-3888  &> /opt/hashicorp/consul/logs/edge-n17-zk-3888.log &  echo $! > /opt/hashicorp/consul/logs/edge-n17-zk-3888.pid'
...
ansible n18 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n18-zk-3888  &> /opt/hashicorp/consul/logs/edge-n18-zk-3888.log &  echo $! > /opt/hashicorp/consul/logs/edge-n18-zk-3888.pid'

ansible n13,n15,n16,n17,n18 -m shell -a 'nohup consul connect proxy -service edge-zk-3888 $upstreams  &> /opt/hashicorp/consul/logs/edge-zk-3888.log & echo $! > /opt/hashicorp/consul/logs/edge-zk-3888.pid'
#
...
ansible n13 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n13-cs-7000  &> /opt/hashicorp/consul/logs/edge-n13-cs-7000.log &  echo $! > /opt/hashicorp/consul/logs/edge-n13-cs-7000.pid'
...
ansible n15 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n15-cs-7000  &> /opt/hashicorp/consul/logs/edge-n15-cs-7000.log &  echo $! > /opt/hashicorp/consul/logs/edge-n15-cs-7000.pid'
...
ansible n16 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n16-cs-7000  &> /opt/hashicorp/consul/logs/edge-n16-cs-7000.log &  echo $! > /opt/hashicorp/consul/logs/edge-n16-cs-7000.pid'
...
ansible n17 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n17-cs-7000  &> /opt/hashicorp/consul/logs/edge-n17-cs-7000.log &  echo $! > /opt/hashicorp/consul/logs/edge-n17-cs-7000.pid'
...
ansible n18 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n18-cs-7000  &> /opt/hashicorp/consul/logs/edge-n18-cs-7000.log &  echo $! > /opt/hashicorp/consul/logs/edge-n18-cs-7000.pid'

ansible n13,n15,n16,n17,n18 -m shell -a 'nohup consul connect proxy -service edge-cs-7000 $upstreams  &> /opt/hashicorp/consul/logs/edge-cs-7000.log & echo $! > /opt/hashicorp/consul/logs/edge-cs-7000.pid'
#
...
ansible n13 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n13-cs-9042  &> /opt/hashicorp/consul/logs/edge-n13-cs-9042.log &  echo $! > /opt/hashicorp/consul/logs/edge-n13-cs-9042.pid'
...
ansible n15 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n15-cs-9042  &> /opt/hashicorp/consul/logs/edge-n15-cs-9042.log &  echo $! > /opt/hashicorp/consul/logs/edge-n15-cs-9042.pid'
...
ansible n16 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n16-cs-9042  &> /opt/hashicorp/consul/logs/edge-n16-cs-9042.log &  echo $! > /opt/hashicorp/consul/logs/edge-n16-cs-9042.pid'
...
ansible n17 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n17-cs-9042  &> /opt/hashicorp/consul/logs/edge-n17-cs-9042.log &  echo $! > /opt/hashicorp/consul/logs/edge-n17-cs-9042.pid'
...
ansible n18 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n18-cs-9042  &> /opt/hashicorp/consul/logs/edge-n18-cs-9042.log &  echo $! > /opt/hashicorp/consul/logs/edge-n18-cs-9042.pid'

ansible n13,n15,n16,n17,n18 -m shell -a 'nohup consul connect proxy -service edge-cs-9042 $upstreams  &> /opt/hashicorp/consul/logs/edge-cs-9042.log & echo $! > /opt/hashicorp/consul/logs/edge-cs-9042.pid'
#
...
ansible n13 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n13-cs-9160  &> /opt/hashicorp/consul/logs/edge-n13-cs-9160.log &  echo $! > /opt/hashicorp/consul/logs/edge-n13-cs-9160.pid'
...
ansible n15 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n15-cs-9160  &> /opt/hashicorp/consul/logs/edge-n15-cs-9160.log &  echo $! > /opt/hashicorp/consul/logs/edge-n15-cs-9160.pid'
...
ansible n16 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n16-cs-9160  &> /opt/hashicorp/consul/logs/edge-n16-cs-9160.log &  echo $! > /opt/hashicorp/consul/logs/edge-n16-cs-9160.pid'
...
ansible n17 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n17-cs-9160  &> /opt/hashicorp/consul/logs/edge-n17-cs-9160.log &  echo $! > /opt/hashicorp/consul/logs/edge-n17-cs-9160.pid'
...
ansible n18 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n18-cs-9160  &> /opt/hashicorp/consul/logs/edge-n18-cs-9160.log &  echo $! > /opt/hashicorp/consul/logs/edge-n18-cs-9160.pid'

ansible n13,n15,n16,n17,n18 -m shell -a 'nohup consul connect proxy -service edge-cs-9160 $upstreams  &> /opt/hashicorp/consul/logs/edge-cs-9160.log & echo $! > /opt/hashicorp/consul/logs/edge-cs-9160.pid'
#
...
ansible n03 -m shell -a 'nohup consul connect proxy -sidecar-for edge-n03-ms-8080  &> /opt/hashicorp/consul/logs/edge-n03-ms-8080.log &  echo $! > /opt/hashicorp/consul/logs/edge-n03-ms-8080.pid'

ansible n01,n02,n03,n04,n05,n06,n07,n19 -m shell -a 'nohup consul connect proxy -service edge-ms-8080 $upstreams  &> /opt/hashicorp/consul/logs/edge-ms-8080.log & echo $! > /opt/hashicorp/consul/logs/edge-ms-8080.pid'
#
