...
then
   $DRYRUN ansible dc3n05 -a $DRYESC$DRYQUOTE"apigee-service apigee-zookeeper $ACTION$DRYESC$DRYQUOTE"
   if [[ $? -ne 0 ]]; then exit 1; fi
fi
...
if [[ ";dc-3;planet;" =~ ";$TARGET;" ]]
then
   $DRYRUN ansible dc3n06 -a $DRYESC$DRYQUOTE"apigee-service apigee-zookeeper $ACTION$DRYESC$DRYQUOTE"
   if [[ $? -ne 0 ]]; then exit 1; fi
fi
...
if [[ ";dc-3;planet;" =~ ";$TARGET;" ]]
then
   $DRYRUN ansible dc3n07 -a $DRYESC$DRYQUOTE"apigee-service apigee-zookeeper $ACTION$DRYESC$DRYQUOTE"
   if [[ $? -ne 0 ]]; then exit 1; fi
fi
...
if [[ ";dc-3;planet;" =~ ";$TARGET;" ]]
then
   $DRYRUN ansible dc3n05 -a $DRYESC$DRYQUOTE"apigee-service apigee-cassandra $ACTION$DRYESC$DRYQUOTE"
   if [[ $? -ne 0 ]]; then exit 1; fi
fi
...
if [[ ";dc-3;planet;" =~ ";$TARGET;" ]]
then
   $DRYRUN ansible dc3n06 -a $DRYESC$DRYQUOTE"apigee-service apigee-cassandra $ACTION$DRYESC$DRYQUOTE"
   if [[ $? -ne 0 ]]; then exit 1; fi
fi
...
if [[ ";dc-3;planet;" =~ ";$TARGET;" ]]
then
   $DRYRUN ansible dc3n07 -a $DRYESC$DRYQUOTE"apigee-service apigee-cassandra $ACTION$DRYESC$DRYQUOTE"
   if [[ $? -ne 0 ]]; then exit 1; fi
fi
