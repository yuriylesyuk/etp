...
ansible n01,n02,n03,n04 -ba "iptables -t filter -A CONSUL_INPUT -m owner --uid-owner consul -j RETURN"
ansible n01,n02,n03,n04 -ba "iptables -t filter -A CONSUL_INPUT -m owner --gid-owner consul -j RETURN"

ansible n01,n02,n03,n04 -ba "iptables -t filter -F CONSUL_INPUT"
ansible n01,n02,n03,n04 -ba "iptables -t filter -X CONSUL_INPUT"
ansible n01,n02,n03,n04 -ba "iptables -t filter -N CONSUL_INPUT"
ansible n01,n02,n03,n04 -ba "iptables -t filter -A OUTPUT -p tcp -j CONSUL_INPUT"
ansible n01,n02,n03,n04 -ba "iptables -t filter -A CONSUL_INPUT -m owner --uid-owner consul -j RETURN"
ansible n01,n02,n03,n04 -ba "iptables -t filter -A CONSUL_INPUT -m owner --gid-owner consul -j RETURN"

ansible n01,n02,n03,n04 -ba "iptables -t nat -F CONSUL_INPUT"
ansible n01,n02,n03,n04 -ba "iptables -t nat -X CONSUL_INPUT"
ansible n01,n02,n03,n04 -ba "iptables -t nat -N CONSUL_INPUT"
ansible n01,n02,n03,n04 -ba "iptables -t nat -A INPUT -p tcp -j CONSUL_INPUT"
ansible n01,n02,n03,n04 -ba "iptables -t nat -A CONSUL_INPUT -m owner --uid-owner consul -j RETURN"
ansible n01,n02,n03,n04 -ba "iptables -t nat -A CONSUL_INPUT -m owner --gid-owner consul -j RETURN"

ansible n01,n02,n03,n04 -ba "iptables -t nat -F CONSUL_INPUT"
ansible n01,n02,n03,n04 -ba "iptables -t nat -X CONSUL_INPUT"
ansible n01,n02,n03,n04 -ba "iptables -t nat -N CONSUL_INPUT"
ansible n01,n02,n03,n04 -ba "iptables -t nat -A OUTPUT -p tcp -j CONSUL_INPUT"
ansible n01,n02,n03,n04 -ba "iptables -t nat -A CONSUL_INPUT -m owner --uid-owner consul -j RETURN"
ansible n01,n02,n03,n04 -ba "iptables -t nat -A CONSUL_INPUT -m owner --gid-owner consul -j RETURN"
